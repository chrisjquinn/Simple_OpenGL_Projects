...
void display()
{
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glPushMatrix();
				...
				glRotatef(g_elbow_angle, 0,0,1);
				//note: glRotatef(g_elbow_angle, 0,0,0) and glRotatef(g_elbow_angle, 1,0,0) also work
				...
				glPushMatrix();
					...
					// set the wrist angle and hand angles
    ...
    glDisable(GL_LIGHTING);
        ...
        draw_text(20, 840, "Use 'w'/'W' to change wirst angle");
